...
export const CreditCardInfo = () => {
  return (
    <div className="flex-1 min-w-[545px] w-full flex flex-col bg-white rounded-lg py-3 gap-[12px]">
      ...
      <div className="flex-1 flex flex-col gap-[12px]">
        <div className="flex flex-col border border-[#DCDCDC] rounded-lg py-3  mx-4 gap-3">
          ...
          <div className="border-[#DCDCDC] rounded-lg gap-2 flex flex-col px-4">
            <div className="h-[70px] bg-[#DCE4FF] border-[2px] border-primary rounded-lg flex gap-2 items-center justify-between px-6">
            ...
            <div className="h-[70px] border border-[#DCDCDC] rounded-lg flex gap-2 items-center justify-between px-6">
              <div className="flex gap-4 items-center">
